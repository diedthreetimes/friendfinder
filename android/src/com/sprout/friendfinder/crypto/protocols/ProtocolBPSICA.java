...
import com.sprout.friendfinder.crypto.protocols.bearercap.BPSICA;

import android.util.Log;

public class ProtocolBPSICA implements Protocol {
  
  static final String TAG = ProtocolBPSICA.class.getSimpleName();
  ...
  public void runTest(CommunicationService cs, ProtocolCallback callback, AuthorizationObject auth) {
    new BPSICATest(cs, auth, callback).execute();
  }
  ...
  private class BPSICATest extends BPSICA {
    ProtocolCallback callback;

    public BPSICATest(CommunicationService s,
